...
rem  Uso:
rem    listar-jars-intellij.bat "C:\Program Files\JetBrains\IntelliJ IDEA 2026.1"
rem  (se nao passar o caminho, usa o default abaixo)
rem ============================================================

set "IDEA=%~1"
if "%IDEA%"=="" set "IDEA=C:\Program Files\JetBrains\IntelliJ IDEA 2026.1"

if not exist "%IDEA%\lib" (
    echo [ERRO] A pasta "%IDEA%\lib" nao existe.
    echo Passe o caminho da sua IntelliJ, por exemplo:
    echo     listar-jars-intellij.bat "C:\Program Files\JetBrains\IntelliJ IDEA 2026.1"
